...
// pillcycle: empty-space double-click order is solid -> transparent -> pills.
// Unknown/empty input falls back to solid so a fresh config lands visible.
function nextBarMode(value) {
  var m = String(value || "").toLowerCase()
  if (m === "solid") return "transparent"
  if (m === "transparent") return "pills"
  if (m === "pills") return "solid"
  return "solid"
}
